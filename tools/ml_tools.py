...
def svm_and_knn_classification(
    ...
    for subset in os.listdir(dataset_path):
        ...
        for _ in range(100):
            ...
            knn = KNeighborsClassifier(
                n_neighbors=grid_search.best_params_.get("n_neighbors")
            )
        ...
        k_svm_scores.append(np.mean(subset_k_svm_scores, axis=0))
        knn_scores.append(np.mean(subset_knn_scores, axis=0))
